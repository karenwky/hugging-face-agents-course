...
# prompt of task details
prompt = """
Search for images of bengal cat and summarize a detailed visual description based on those images. 
Navigate to Wikipedia to gather key details about its health issues. 
Group above results as final answer in below format:
=====Appearance=====
"YOUR_ANSWER"
=====Health Concerns=====
"YOUR_ANSWER"
...
# Define arguments to call function
def parse_arguments(): 
    parser = argparse.ArgumentParser(description="Run a web browser automation script with a specified model.")
    parser.add_argument(
        "prompt", 
        type=str, 
        nargs="?",  # Set as optional
        default=prompt, 
...
# Save screenshot to perform observations
...
def main():
    ...
    agent.run(args.prompt + helium_instructions, reset=False)
